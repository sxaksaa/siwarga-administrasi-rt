...
export default function Layout() {
  ...
  return <div className="app-shell">
    ...
    <main className="main-area">
      <header className="topbar"><button className="menu-button" onClick={() => setOpen(true)}><Menu /></button><div><small>Administrasi Perumahan</small><h1>{activeLabel}</h1></div><div className="today">RT 05 <span>•</span> RW 02</div></header>
